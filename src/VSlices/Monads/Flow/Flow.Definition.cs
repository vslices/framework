    ...
    : K<Flow<RT, REQ>, RES>
{
    ...
    /// <summary>
    /// Implicitly converts a <see cref="Pure{RES}"/> instance to a <see cref="Flow{RT, REQ, RES}"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Implicitly converts a <see cref="Fail{Error}"/> instance to a <see cref="Flow{RT, REQ, RES}"/> instance.
    /// </summary>
