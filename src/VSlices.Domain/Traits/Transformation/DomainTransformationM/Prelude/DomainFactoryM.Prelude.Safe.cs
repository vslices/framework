...
public static partial class VSlicesDomainPrelude
{
    ...
    /// <typeparam name="T">
    /// The type implementing both <see cref="DomainTransformationM{T, M, char}"/> and <see cref="DomainType{T, char}"/>.
    /// </typeparam>
    ...
    /// </typeparam>
    /// <typeparam name="T">
    /// The domain type to be created, which must implement both <see cref="DomainTransformationM{T, M, byte}"/>
    ...
    /// <typeparam name="T">The domain type that implements both <see cref="DomainTransformationM{T, M, ushort}"/>
    ...
    /// <see cref="DomainTransformationM{T, M, int}"/> and <see cref="DomainType{T, int}"/>.
    /// </typeparam>
    /// <param name="repr">
    ...
    /// </typeparam>
    /// <typeparam name="T">
    /// The domain type that implements both <see cref="DomainTransformationM{T, M, uint}"/>
    ...
    /// <typeparam name="T">The domain type to be created, which implements <see cref="DomainTransformationM{T, M, long}"/> and <see cref="DomainType{T, long}"/>.</typeparam>
    ...
    /// </summary>
    /// <typeparam name="M">The monad type that defines the computational context.</typeparam>
    /// <typeparam name="T">The domain type to be created, which must implement both <see cref="DomainTransformationM{T, M, ulong}"/> and <see cref="DomainType{T, ulong}"/>.</typeparam>
    /// <param name="repr">The representation value used to create the domain type instance.</param>
    /// <returns>A new instance of the domain type wrapped in the computational context defined by <typeparamref name="M"/>.</returns>
    ...
    /// </summary>
    /// <typeparam name="M">The monad type that defines the context for the operation.</typeparam>
    /// <typeparam name="T">The domain type to be created, which must implement both <see cref="DomainTransformationM{SELF, M, IN}"/> and <see cref="DomainType{SELF, REPR}"/>.</typeparam>
    /// <param name="repr">The representation value used to create the domain type instance.</param>
    /// <returns>A new instance of the domain type wrapped in a monadic context.</returns>
    ...
    /// </summary>
    /// <typeparam name="M">The monad type that defines the context for the operation.</typeparam>
    /// <typeparam name="T">The domain type to be created, which must implement both <see cref="DomainTransformationM{T, M, double}"/> and <see cref="DomainType{T, double}"/>.</typeparam>
    /// <param name="repr">The representation value used to create the domain type instance.</param>
    /// <returns>A new instance of the domain type wrapped in a <see cref="FinT{M, T}"/>.</returns>
    ...
    /// <typeparam name="T">The domain type that implements <see cref="DomainTransformationM{SELF, M, TYPE, IN}"/> and <see cref="DomainType{SELF, REPR}"/>.</typeparam>
    /// <param name="repr">The representation value used to create the domain type instance.</param>
    ...
    /// </summary>
    /// <typeparam name="M">The monad type that defines the computation context.</typeparam>
    /// <typeparam name="T">The domain type to be created, which must implement both <see cref="DomainTransformationM{T, M, TimeOnly}"/>
    ...
    /// </summary>
    /// <typeparam name="M">The monad type that defines the context for the operation.</typeparam>
    /// <typeparam name="T">The domain type to be created, which must implement <see cref="DomainTransformationM{T, M, DateTimeOffset}"/> and <see cref="DomainType{T, DateTimeOffset}"/>.</typeparam>
    ...
    /// <typeparam name="T">The domain type to be created, which implements both <see cref="DomainTransformationM{T, M, TimeSpan}"/> and <see cref="DomainType{T, TimeSpan}"/>.</typeparam>
    ...
    /// <see cref="DomainTransformationM{T, M, Guid}"/> and <see cref="DomainType{T, Guid}"/>.
    /// </typeparam>
